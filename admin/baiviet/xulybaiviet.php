...
<?php	
	...
	{		
		...
		if ($action=="themmoi")
		{
			...
			$sql = "insert into baiviet (idchuyenmuc,tenbaiviet, tomtat, noidung, anh, ngaydang, idtacgia, trangthai)";
			$sql = $sql." values('{$idchuyenmuc}', '{$tenbaiviet}','{$tomtat}','{$noidung}','{$anh}',NOW(),'{$_SESSION['tendangnhap']}','inactive')";
